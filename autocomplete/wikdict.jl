...
# ╔═╡ b3149d74-6590-11ed-24c7-11f49ae406b4
begin
	using SQLite
	using DataFrames
	using PlutoUI
...
# ╔═╡ 231e6b04-2881-4145-bc4e-89ecfcfd9421
db = SQLite.DB("en-de.sqlite3")

# ╔═╡ 0c8ff803-4660-44aa-a7ed-3b281a09b9b1
@bind query TextField(placeholder="Search term")

# ╔═╡ d942431b-483c-421e-8f2e-3de282d46733
DBInterface.execute(
	db,
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "3c00cd8242a6617b40a388a4f030d216899692d3"
...
git-tree-sha1 = "277f6e968a054a197ebaa673ef8afdfa5911e0d2"
